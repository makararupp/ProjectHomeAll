...
<template>
  <div class="category-page">
    ...
    <main class="category-main container">
      <!-- Breadcrumb Navigation: Home > Product Categories > Consignment Products -->
      <nav class="category-breadcrumb" aria-label="Breadcrumb">
        ...
        <span class="category-breadcrumb_current" aria-current="page">
          {{ t('servicesSection.consignment', 'Consignment Products') }}
        </span>
      </nav>

      <!-- Clean Empty State Card matching Salon/Logistics style -->
